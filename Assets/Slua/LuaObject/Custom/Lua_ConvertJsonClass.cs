...
public class Lua_ConvertJsonClass : LuaObject {
	...
	static public int Awake(IntPtr l) {
		try {
			...
			#endif
			#endif
			ConvertJsonClass self=(ConvertJsonClass)checkSelf(l);
			self.Awake();
			pushValue(l,true);
			return 1;
		}
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"ConvertJsonClass");
		addMember(l,Awake);
		addMember(l,initComplete);
		addMember(l,"fileName",get_fileName,null,true);
		createTypeMetatable(l,null, typeof(ConvertJsonClass),typeof(LuaBehavior));
	}
}
