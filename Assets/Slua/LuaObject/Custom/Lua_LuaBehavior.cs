...
public class Lua_LuaBehavior : LuaObject {
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int setBindingDataMaps(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			#endif
			LuaBehavior self=(LuaBehavior)checkSelf(l);
			Binding.BindingNode a1;
			checkType(l,2,out a1);
			self.setBindingDataMaps(a1);
			pushValue(l,true);
			return 1;
		}
		catch(Exception e) {
	...
	static public int getBindingComponent(IntPtr l) {
		try {
			...
			System.String a1;
			checkType(l,2,out a1);
			var ret=self.getBindingComponent(a1);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,Start);
		addMember(l,setBindingDataMaps);
